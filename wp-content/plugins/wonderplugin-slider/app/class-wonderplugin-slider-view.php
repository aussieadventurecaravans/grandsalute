...
class WonderPlugin_Slider_View {
	...
	function print_item()
	{
		...
		<?php
		if (WONDERPLUGIN_SLIDER_VERSION_TYPE !== "C")
			echo '<div class="updated"><p style="text-align:center;">To remove the Free Version watermark, please <a href="https://www.wonderplugin.com/order/?product=slider" target="_blank">Upgrade to Commercial Version</a>.</p></div>';
