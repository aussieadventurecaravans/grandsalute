...
//var_dump($lati);
//if($lati =='' || $longt==''){
//    $lati = '-41.990777187879694';
//    $longt = '145.48831036452634';
//}
?> 
        ...
        <div class="row">
            ...
            <div class="col-lg-offset-2 no_left">
                <form class="form-inline">
                    ...
                    <div class="form-group">
                        <label for="exampleInputName2" class="dealer_name_label">Name</label>
        ...
        <div class="row" style="margin-bottom:70px;">
            <div class="col-md-4 nopadding" id="leftp">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="Results" class="col-md-6  col-xs-12 active uppercase"><a href="#results" aria-controls="Results" role="tab" data-toggle="tab">Results</a></li>
...
//                                var_dump($query_);
    ...
    <li class="dl_ulli" data-lat="<?php echo $lati; ?>" data-lang="<?php echo $longt; ?>">
                                    <span class="uppercase ttl1"><?php echo $com_nm; ?></span><p><?php echo $addr ?></p><p>T: &nbsp;<?php echo $tel_nml; ?></p><p>E:<a href="mailto:<?php echo $em_ad; ?>"><?php echo $em_ad; ?></a> </p> <p>W:<a href="http://<?php echo $web_ad; ?>"> <?php echo $web_ad; ?></a></p>
                                </li>
 <?php   
}
                                ?>
                        ...
                        <div class="location-inputs">
                            <div class="direction-select pull-left ">
                                <div class="direction-from">
                                    ...
                                    <div class="btn-group">
                                        <input type="search" class="form-control" id="txtSource" placeholder="Melbourne, Australia">
                                ...
                                <div class="direction-to">
                                    ...
                                    <div class="btn-group">
                                        <input type="search" class="form-control" id="txtDestination" placeholder="Sydney, Australia">
                                        <span class="searchclear"></span>
                                    </div>
                                </div>
                            </div>
