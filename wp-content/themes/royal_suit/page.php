...
$rm_pg = cedo_get_option('cedo_rm_id');
$sm_pg = cedo_get_option('cedo_sm_id');
$tc_pg = cedo_get_option('cedo_tcp_id');
$pp_pg = cedo_get_option('cedo_pp_id');
...
<?php } else { ?>
    ...
    <div class="range-heroimg au_header" style="background-color:#6C6E6B;">
        <div class="container ">
            <div class="row">
                <h1><?php
    $ttl_bnr = get_field('main_banner_title', $pg_id);
...
<?php if ($pg_id == $ab_pg || $pg_id == $ac_pg) { ?>
    ...
    <?php
    } elseif ($pg_id == $sm_pg || $pg_id == $tc_pg || $pg_id == $pp_pg) { ?>
        <div class="page_intro single_nitem single-column srvc_bhags">
    <?php } else {
        ?>
                ...
                <div class="col-md-12 ">
                            ...
                            <div class="row">
                                <div class="col-md-12 preffix_2 all_p-wrp">
                                    <?php
                                    if ($pg_id == $tc_pg || $pg_id == $pp_pg) {
                                        ?>
                                        <div class="cond_bhags">
