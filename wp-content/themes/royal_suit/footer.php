    ...
    <div class="firs-section">
        <div class="container footer_main_continer">
            ...
            <div class="row">
                ...
                ?>
                <div class="col-md-3 col-sm-6 col-xs-12 nws_bhags">
                    <div class="social-icons">
                        <a class="s-icons icon-fb" href="<?php echo cedo_get_option('cedo_fb_link'); ?>" target="_blank"></a>
                        <a class="s-icons icon-tw" href="<?php echo cedo_get_option('cedo_tw_link'); ?>" target="_blank"></a>
                        <a class="s-icons icon-yt" href="<?php echo cedo_get_option('cedo_yt_link'); ?>" target="_blank"></a>
                        <a class="s-icons icon-ig" href="<?php echo cedo_get_option('cedo_ins_link'); ?>" target="_blank"></a>
                    </div>
                    <h4>Newsletter</h4>
                    <form>
...
<!--                                <div class="col-md-6">-->
                                    ...
                                    <br> 
                                    <span>
                                        <?php echo cedo_get_option('cedo_cra_txt'); ?>
                                        <a target="_blank" href="<?php echo cedo_get_option('cedo_cra_lnk'); ?>">&nbsp;<?php echo cedo_get_option('cedo_cra_company'); ?>
                                        </a>
                                    </span>
<!--                                </div>-->
                                <!--                                <br>-->
