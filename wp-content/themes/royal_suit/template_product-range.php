...
<div class="range-heroimg" style="background-color:#6C6E6B;">
    <div class="container ">
        <div class="row">
            <h1>OFF-ROAD</h1>
        </div>
...
<div class="filters filter_range" id="scroll_here">
    <div class="container ">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 range_input_bhags">
                <label for="inputEmail3" class="control-label " id="lbl_price">Price</label>
                <?php
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 range_input_bhags">
                <label for="inputEmail3" class="control-label " id="lbl_length">Length</label>
                <?php
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 last_pro_category range_input_bhags">
                <label for="inputEmail3" class="control-label " id="lbl_cat">Category</label>
    ...
    <div class="container ">
        <div class="row scroll">
            <div class="data-loading hide_load" style="display: none">
                <p>Loading Results</br><img src="<?php echo get_template_directory_uri() ?>/img/range_loader.gif"/></p>
            </div>
                            ...
                            <span class="bhags_wrp">
                                ...
                                <span class="fl_rng EqHeightDiv_3 EqHeightDiv4">
                                    <span class="feature_desc_wrpper">
                                        <?php
                                        if($product_title_count>16){
                                            ?>
                                        <h4><?php echo substr($product_title,0,17); ?>..</h4>
                                        <?php
                                        }
                                        else{
                                            ?>
