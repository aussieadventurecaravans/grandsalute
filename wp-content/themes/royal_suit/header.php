...
<!--        <link href='https://fonts.googleapis.com/css?family=Oswald|News+Cycle' rel='stylesheet' type='text/css'>-->
...
//            $link_blog[$_post1->post_title] = get_permalink($_post1->ID);
        ...
        <script>
            ...
            jQuery(document).ready(function() {
                jQuery('.top-menu-bar').last().after().append('<li class="search-icon"><a href="#"><span class="glyphicon glyphicon-search"></span></a></li>');
                ...
                jQuery('.top-menu-bar li a').prepend('<i class="fa fa-angle-right"></i>');
                //                jQuery('.top-menu-bar').append('<li class="search-icon"><a href="#"><span class="glyphicon glyphicon-search"></span></a></li>');
                //            jQuery('.top-menu-bar').append('<li class="visible-xs"><a href="#">Find a Dealer</a></li><li class="visible-xs"><a href="#">Contact Us</a></li>\n\
                //                   <li class="search-icon"><a href="#"><span class="glyphicon glyphicon-search"></span></a></li>');
...
<!--                                            <div class="logo_brnd"><a class="navbar-brand logo text-hide" href="<?php bloginfo('url'); ?>">Dream Seeker</a></div>-->
                    ...
                    <div class="second_main_navbar col-md-12" style="padding:0px;">
                        ...
                        <div class="col-md-6 logo">
                            <a href="<?php echo home_url('/'); ?>">
                                <img src="<?php echo get_template_directory_uri() ?>/image/grand_salute_logo_final.png"/>
                            </a>
                        </div>
                        <div class="container header_bhags">
                            <div id="navbar" class="navbar-collapse collapse navbar-primary" style="float:left;width:100%; margin-top:64px;">
                                <?php
                                wp_nav_menu(array(
