...
//       });
   ...
   <nav class="navbar navbar-inverse navbar-top second-navbar hidden-xs navbar-fixed-top upcoming_bhags" role="navigation">
      <div class="container"> 
...
<!--    <div class="range-heroimg" style="background-image:url('<?php //echo get_template_directory_uri() ?>/img/range-heroimg.jpg');">-->
        <div class="range-heroimg up_header" style="background-color:#6C6E6B;">
        <div class="container ">
            <div class="row">
