...
//    register_sidebar('sidebar-1');
    register_sidebar( array(
        'name' => __( 'Main Sidebar', 'royal_suit' ),
        'id' => 'sidebar-1'       
    ) );
}
...
//menu
    ...
    if (!is_admin()) {
        //stylesheets
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/bootstrap.min.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/bootstrap-theme.min.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/main.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/font-awesome.min.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/dropdown.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/jquery.bxslider.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/noJS.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/colorbox.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/owl-carousel/owl.theme.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/prettyPhoto.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/owl-carousel/owl.carousel.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/jquery.fancybox.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/jquery.fancybox-thumbs.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/datepicker.css')) {
...
//        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/jquery-ui.structure.min.css')) {
...
//        }
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/jquery-ui.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/jquery.jscrollpane.css')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/css/custom.css')) {
            wp_register_style('custom_css', trailingslashit(get_template_directory_uri()) . 'css/custom.css', false, '1.0', 'all');
            wp_enqueue_style('custom_css');
        }
//        javascripts
        
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jquery.js')) {
          ...
          if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jquery-migrate-1.2.1.min.js')) {
          ...
          if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jquery-ui.min.js')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/bootstrap.min.js')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jquery.bxslider.min.js')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jquery.jscrollpane.min.js')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/ajaxupload.3.5.js')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jquery.selectBoxIt.min.js')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jquery.colorbox-min.js')) {
        ...
        if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jquery.jscroll.js')) {
            ...
            wp_enqueue_script('drm_scroll');
             ...
             if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/main.js')) {
            ...
            wp_enqueue_script('drm_main_js');
             ...
             if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/owl.carousel.js')) {
         ...
         if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jquery.prettyPhoto.js')) {
         ...
         if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/script_new.js')) {
...
//             if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jquery.fancybox.js')) {
...
//        }
             if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jquery.fancybox.pack.js')) {
            ...
            wp_enqueue_script('drm_fancy_box_pack');
             ...
             if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jquery.fancybox-thumbs.js')) {
            ...
            wp_enqueue_script('drm_fancy_box_thumb');
             ...
             if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/bootstrap-datepicker.js')) {
            ...
            wp_enqueue_script('drm_boot_date');
             ...
             if (file_exists(ABSPATH . 'wp-content/themes/royal_suit/js/jQuery.MultiFile.min.js')) {
