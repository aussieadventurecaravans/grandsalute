...
//               'menu_class'      => 'nav navbar-nav navbar-right'
        ...
        <nav class="navbar navbar-inverse navbar-top navbar-fixed-top" role="navigation" style="">
            <div class="container-fluid" style="">
                <div class="col-md-12" style="">
                    <div class="navbar-header col-md-2" style="">
                        ...
                        <!--                        <div class="logo_brnd">
                                                    <a class="navbar-brand logo text-hide" href="<?php bloginfo('url'); ?>">
                                                        DreamSeeker
                                                    </a>
                                                </div>-->
                    </div>
                    <div class="second_main_navbar col-md-12 bhgs_nav_scnd" style="padding:0px;">
                        <div id="navbar-secondary" class="hidden-xs navbar-collapse navbar-secondary scnd_range_bhags" style="float:left;width:100%;margin-top: -5px;">
                            <?php
                            wp_nav_menu(array(
                                'theme_location' => 'header-top-menu',
                                'menu_class' => 'top-menu-bar nav navbar-nav navbar-right'
                        ...
                        <div class="container header_range_bhags">   
                            <div id="navbar" class="navbar-collapse collapse navbar-primary ss_navbar" style="float:left;width:100%; margin-top:64px;">
                                <?php
                                wp_nav_menu(array(
                                    'theme_location' => 'header-menu',
                                    'menu_class' => 'nav navbar-nav navbar-right'
