...
<div class="range-heroimg claim_bhags2" style="background-color:#6C6E6B;">
    <div class="container ">
        <div class="row">
            <h1>make a claim</h1>
        </div>
...
<!--                    <h2>Make a claim</h2>-->
                ...
                <form action="" method="post" enctype="multipart/form-data" class="clm_frm">
                    ...
                    ?>
                    <div class="form-group col-md-6 mdl_bhags">
...
<?php // }  ?>
                        ...
                        <div class="form-group col-md-12 dlrshp_bhags" style="padding-left:0;padding-right:0;">
...
<?php } ?>
                        ...
                        <div class="form-group sub_clim sub_btn_bhags">
                    ...
                    <div class="form-group col-md-6 upld_bhags">
                        <div id="upload" class="claim_up"><span id="up_bhags">Upload Images<span></div><span id="status" ></span>		
